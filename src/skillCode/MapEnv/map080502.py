...
class NormalMap_080502_1(PrepSkill):
...
class NormalMap_080502_2(PrepSkill):
    """航母、轻母装甲-10"""
    def __init__(self, timer):
        super().__init__(timer, master=None)
...
name = '8-5封锁战况(削弱后)'
effect = '敌方舰队旗舰存活时，为所有非旗舰单位提供10%减伤；航母、轻母装甲-10。'
skill = [NormalMap_080502_1, NormalMap_080502_2]
