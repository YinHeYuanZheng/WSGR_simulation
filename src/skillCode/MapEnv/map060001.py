...
class NormalMap_060001_1(PrepSkill):
...
class NormalMap_060001_2(PrepSkill):
    """敌方全体射程变更为长"""
    def __init__(self, timer):
        super().__init__(timer, master=None)
...
name = '6图战利品战况(削弱前)'
effect = '敌方舰队每存活一个非旗舰单位都会为旗舰提供10%减伤，敌方全体射程变更为长。'
skill = [NormalMap_060001_1, NormalMap_060001_2]
