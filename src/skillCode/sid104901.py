...
class Skill_104901_2(Skill):
    ...
    def activate(self, friend, enemy):
        num = len(TypeTarget(side=1,shiptype=MainShip).get_target(friend,enemy))
        if(num >= 3):super().activate(friend,enemy)
class Skill_104901_3(Skill):
    ...
    def activate(self, friend, enemy):
        num = len(TypeTarget(side=1,shiptype=CoverShip).get_target(friend,enemy))
        if(num >= 3):super().activate(friend,enemy)
